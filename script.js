document.addEventListener('DOMContentLoaded', () => {
    ...
    if (clearInventoryForm) {
        clearInventoryForm.addEventListener('submit', (e) => {
            ...
            fetch('https://inventory-management-7wqt.onrender.com/api/clearInventory', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    if (displaySuppliers) {
        fetch('https://inventory-management-7wqt.onrender.com/api/suppliers')
            .then(response => response.json())
            .then(data => {
    ...
    if (searchProductForm) {
        searchProductForm.addEventListener('submit', (e) => {
            ...
            fetch('https://inventory-management-7wqt.onrender.com/api/searchProduct', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
